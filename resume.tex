...
%    \item Created utility for auditing DNS records and documentation of IPMI interfaces
%    \item Participated in weekly code reviews to learn about and improve new utilities written by coworkers
    \end{rSubsection}
%
%%------------------------------------------------------------------------------
%
...
%    \item Researched and evaluated tool for integration into patch management and approval process
%    \end{rSubsection}
%
%%------------------------------------------------------------------------------
%
